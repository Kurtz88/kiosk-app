/**
 * DB의 /uploads/… → https://dgbukfood.co.kr/uploads/… 직접 (API 프록시 없음)
 * 로컬 public/uploads만 쓸 때: KIOSK_UPLOADS_BASE_URL=0
 */
const DEFAULT_UPLOADS_PUBLIC_BASE = 'https://dgbukfood.co.kr/uploads';

/** 예전 iniini 경로 → 새 호스트로 치환 */
...
function migrateLegacyUploadUrl(urlStr) {
    return String(urlStr || '').replace(LEGACY_INIINI_UPLOAD_PREFIX_RE, () => {
...
/** /uploads/a.jpg · https://dgbukfood…/uploads/a.jpg → 상대 경로 a.jpg */
